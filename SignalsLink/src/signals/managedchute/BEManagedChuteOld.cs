...
{
    public class BEManagedChuteOld : BlockEntityOpenableContainer, IBESignalReceptor
    {
        ...
        public BEManagedChuteOld()
        {
            this.OpenSound = BEManagedChuteOld.hopperOpen;
        ...
        private void TryPullFrom(BlockFacing inputFace, int allowedNow)
        {
            ...
            if (!(num2 <= 0 || this.Api.World.Rand.NextDouble() >= 0.2))
                this.Api.World.PlaySoundAt(BEManagedChuteOld.hopperTumble, this.Pos, 0.0, range: 8f, volume: 0.5f);
        }
